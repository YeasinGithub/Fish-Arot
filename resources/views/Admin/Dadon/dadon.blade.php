            ...
            <div class="card-body">
              <form id="signupForm">
                ...
                <div class="form-group row">
                  ...
                  <label for="input-12" class="col-sm-2 col-form-label">বার</label>
                  <div class="col-sm-4">
               <input type="text" readonly="readonly" id="dayname" class="form-control" name="day">
                ...
                <div class="form-group row">
                  <label for="input-13" class="col-sm-2 col-form-label">মোবাইল</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="mobile">
                  </div>
                  <label for="input-13" class="col-sm-2 col-form-label">মোট টাকা</label>
                  <div class="col-sm-4">
                    <input type="text" id="Dtaka" class="form-control" name="total_amount" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-13" class="col-sm-2 col-form-label">জমা</label>
                  <div class="col-sm-4">
                    <input type="text" id="Dpaid" class="form-control" name="paid">
                  </div>
                  <label for="input-13" class="col-sm-2 col-form-label">মোট অবশিষ্ট</label>
                  <div class="col-sm-4">
                    <input type="text" id="Dlast" class="form-control" name="last_total" readonly>
                  </div>
                </div>
          ...
          <table id="default-datatable" class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td>{{$dadon->name}}</td>
                <td>{{$dadon->address}}</td>
                <td>{{ date('d-m-Y',strtotime($dadon->date)) }}</td>
                <td>{{$dadon->day}}</td>
                <td>{{ date('g:i a',strtotime($dadon->date)) }}</td>
                <td>{{$dadon->mobile}}</td>
                <td>{{$dadon->total_amount}}</td>
                <td>{{$dadon->paid}}</td>
                <td>{{$dadon->last_total}}</td>
                <td>
                  <a href="{{ url('/dadon/edit/') }}" data-id="{{$dadon->id}}" id="dadonId" class="btn btn-sm btn-info">Edit</a>

                  <a href="{{ url('/dadon/delete/') }}" data-id="{{$dadon->id}}" id="deleteId"  class="btn btn-sm btn-danger">Delete</a>
                </td>
              </tr>
                  @php
                    $a+=$dadon->total_amount;
                    $i+=$dadon->paid;
                    $j+=$dadon->last_total;
            ...
            <tr>
                    ...
                    <td style="border-right: none;"></td>
                    <td><b>মোট দাদন</b></td>
                    <td><b>@php echo $a; @endphp টাকা</b></td>
    ...
    {{ csrf_field() }}
      ...
      <div class="form-group">
        ...
        <div class="input-group-prepend">
              ...
              <input type="date" class="form-control" id="Edate" name="date" required>
        </div>
        </div>
        <div class="form-group">
        <div class="input-group-prepend">
        ...
        <div class="input-group-prepend">
              ...
              <input type="text" class="form-control" id="Etotal_amount" name="total_amount">
        </div>
        </div>
        <div class="form-group">
        <div class="input-group-prepend">
        ...
        <div class="input-group-prepend">
              ...
              <input type="number" class="form-control" id="Elast_total" name="last_total" readonly>
        </div>
        </div>
