            ...
            <div class="card-body">
              <form id="signupForm">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="paikar_name" required>
                  </div>
...
<div class="row">
          ...
          <table id="default-datatable" class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="{{ url('/paikar/edit/') }}" data-id="{{$paikar->id}}" id="dadonId" class="btn btn-sm btn-info">Edit</a>

                  <a href="{{ url('/paikar/delete/') }}" data-id="{{$paikar->id}}" id="deleteId"  class="btn btn-sm btn-danger">Delete</a>
                </td>
              </tr>
 ...
 <div class="modal fade" id="editDadon" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <form action="{{url('/paikar/update')}}" method="post" id="editDadonForm">
    {{ csrf_field() }}
      ...
      <div class="form-group">
        <div class="input-group-prepend">
            ...
            <input type="text" class="form-control" id="Enames" name="paikar_name">
        </div>
        </div>
        <div class="form-group">
        <div class="input-group-prepend">
...
<script src="{{asset('paikar.js')}}"></script>
