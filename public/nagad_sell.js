...
/*---------------Edit Data-----------------------*/
 $(document).on("click", "#nagadId", function(arg){
  /*alert('okkks');*/
   arg.preventDefault();
  ...
  $.ajax({
    ...
    success: function(response){
      /*alert(response);*/
          $("#editNagad").modal("show");
          $("#editNagadName").text("Update 's Data");
